...
if __name__ == '__main__':
    ...
    # Add layers
    m.add(
        dense(10, input_dim=60, activation="stable_softmax", bias_config=[0, 0]), net_corner=[0, 0]
    )
    ...
    import pickle
    pickle.dump(m, open(path.tests_folder + 'may02_simuNN/mnist_FC_120x40_simu.pickle', 'wb'))
